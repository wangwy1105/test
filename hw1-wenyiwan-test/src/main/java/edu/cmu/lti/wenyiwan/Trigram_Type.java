...
public class Trigram_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.wenyiwan.Trigram");
  ...
  public int getTokenList(int addr) {
      ...
      jcas.throwFeatMissing("TokenList", "edu.cmu.lti.wenyiwan.Trigram");
  ...
  public int getBegin(int addr) {
      ...
      jcas.throwFeatMissing("begin", "edu.cmu.lti.wenyiwan.Trigram");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("end", "edu.cmu.lti.wenyiwan.Trigram");
