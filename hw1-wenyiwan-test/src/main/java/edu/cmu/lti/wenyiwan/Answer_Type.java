...
public class Answer_Type extends Sentence_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.wenyiwan.Answer");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("Confidence", "edu.cmu.lti.wenyiwan.Answer");
  ...
  public int getBegin(int addr) {
      ...
      jcas.throwFeatMissing("begin", "edu.cmu.lti.wenyiwan.Answer");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("end", "edu.cmu.lti.wenyiwan.Answer");
  ...
  public boolean getIsCorrect(int addr) {
      ...
      jcas.throwFeatMissing("IsCorrect", "edu.cmu.lti.wenyiwan.Answer");
